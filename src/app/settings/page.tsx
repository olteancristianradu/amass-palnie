...
export default function SettingsPage() {
  ...
  return (
    <Layout>
      ...
      <p className="text-[var(--fg-soft)] text-[13px] mb-6 rise">Cont CRM, aspect/temă și Outlook — toate într-un singur loc. Credențialele gestcom sunt criptate AES-256. Parola contului se gestionează de administrator (pagina Echipă).</p>
      ...
      <h2 className="d2sec-lbl text-[13px] font-bold uppercase tracking-[.06em] text-[var(--text)] pb-2 border-b border-[var(--border)] mb-4 max-w-xl rise flex items-center gap-2">
        <span className="dot inline-block w-[7px] h-[7px] rounded-full bg-[var(--accent)]" />Tehnic & integrări
      </h2>
