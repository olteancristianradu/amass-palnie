...
const IP: Record<string, string> = {
  ...
  eyeOff: 'M9.9 4.2A10 10 0 0 1 12 4c6 0 10 8 10 8a18 18 0 0 1-2.3 3.3M6.6 6.6A18 18 0 0 0 2 12s4 8 10 8a10 10 0 0 0 4.7-1.2M3 3l18 18M9.5 9.5a3 3 0 0 0 4.2 4.2',
